...
export class VectorGraphic extends TouchableComponent<IVectorGraphicProperties> {
    ...
    constructor(renderer : APLRenderer, component : APL.Component, factory : FactoryFunction, parent? : Component) {
        ...
        // This needs to refactor once Core supports Spatial Navigation: https://issues.labcollab.net/browse/ELON-2476
    ...
    public async setProperties(props : IVectorGraphicProperties) {
        ...
        $(this.svg).empty();
        // TODO -> when calling component.updateGraphic this flags the graphic property as
